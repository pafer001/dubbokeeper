...
public class ProviderController {
    ...
    public @ResponseBody
    List<Provider> listProviderByService(@PathVariable("serviceKey") String serviceKey) throws UnsupportedEncodingException {
    ...
    public @ResponseBody
    List<Provider> listProviderByHost(@PathVariable("applicationName") String applicationName, @PathVariable("host") String host) {
    ...
    public @ResponseBody
    Map<String, Object> seriveReadMe(@PathVariable("serviceKey") String serviceKey) throws UnsupportedEncodingException {
    ...
    public @ResponseBody
    Provider loadProviderDetail(@PathVariable("id") long id) {
    ...
    public @ResponseBody
    BasicResponse batchOperate(@PathVariable("type") String type, @RequestParam("ids") String ids) {
        BasicResponse basicResponse = new BasicResponse();
        basicResponse.setResult(BasicResponse.SUCCESS);
