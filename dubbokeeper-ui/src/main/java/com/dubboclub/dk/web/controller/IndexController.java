...
public class IndexController {
    ...
    public @ResponseBody
    List<Integer> loadAppsTypeDoughnutChat() {
    ...
    public @ResponseBody
    Map<String, Integer> loadServiceProtocolDoughnutChat() {
    ...
    public @ResponseBody
    Map<String, List<Integer>> loadApplicationServiceStatus() {
        List<Application> applications = applicationService.getApplications();
    ...
    public @ResponseBody
    Map<String, Integer> loadApplicationNodes() {
        List<Application> applications = applicationService.getApplications();
        Map<String, Integer> statistics = new HashMap<String, Integer>();
        for (Application application : applications) {
